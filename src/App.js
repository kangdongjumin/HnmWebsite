...
function App() {
  ...
  return <div>
    <Navbar nowLogin={nowLogin} setNowLogin={setNowLogin} />

    <Routes>
      <Route path="/" element={<ProductAll nowLogin={nowLogin}/>}/>
      <Route path="/login" element={<Login nowLogin={nowLogin} setNowLogin={setNowLogin} />}/>
